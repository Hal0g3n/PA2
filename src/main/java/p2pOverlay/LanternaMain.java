...
public class LanternaMain {
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      for (int i = 8080; i < 8100; i++) {
        ...
        for (String line : baos.toString().split("\n")) {
          ...
          terminal.setCursorPosition(
            0,
            terminal.getCursorPosition().getRow() + 1
          );
          terminal.flush();
          rows++;
        }
      ...
      ActionListDialogBuilder actionListDialog = new ActionListDialogBuilder()
          ...
          new Runnable() {
            ...
            public void run() {
              ...
              mainPanel.setLayoutManager(
                new GridLayout(1).setLeftMarginSize(1).setRightMarginSize(1)
              );
